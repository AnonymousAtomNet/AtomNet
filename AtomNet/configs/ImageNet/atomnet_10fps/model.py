...
if __name__ == "__main__":
    config = {
        'depth': [1, 1, 2, 1, 4, 2],
        'out_channel': [24, 24, 48, 64, 80, 144],
        'block_type_stage': ['conv', 'mobile_one', 'mobile_one', 'mobile_one', 'mbconvnext', 'mbconvnext'],
        ...
        'expand_ratio': [1, 1, 1, 1, 3, 3]
    }
    input_resolution = 80
    atomnet_10fps = atomnet_base(**config)
